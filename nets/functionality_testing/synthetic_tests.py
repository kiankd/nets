...
def test_synthetic_data(d, x, y, save_dir, serialize=False):
    d.set_all_data(x, y)
...
def make_testing():
    ...
    class_sep = 2 # smaller = more difficult
    serialize = False
    ...
    name = 'MED make f{} fred{} k{} cpc{} csep{}'.format(num_features,
                                                         num_redundant,
                                                         num_classes,
    ...
    test_synthetic_data(d, x, y, save_dir, serialize=serialize)
...
def blob_testing():
    ...
    d = SyntheticDataset('Blobs n{} f{} k{} std{}'.format(num_samples,
                                                          num_features,
                                                          num_classes,
                                                          cluster_std))

    save_dir = 'n{}_f{}_k{}_std{}/'.format(num_samples,
                                           num_features,
                                           num_classes,
                                           cluster_std)
